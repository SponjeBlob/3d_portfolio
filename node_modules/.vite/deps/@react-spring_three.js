...
function useSprings(length, props, deps) {
  ...
  function declareUpdates(startIndex, endIndex) {
    for (let i = startIndex; i < endIndex; i++) {
      ...
      if (update22) {
        updates.current[i] = declareUpdate(update22);
      }
    }
  }
  ...
  useIsomorphicLayoutEffect(() => {
    ...
    each(ctrls.current, (ctrl, i) => {
      ...
      const update22 = updates.current[i];
      if (update22) {
...
function useTransition(data, props, deps) {
  ...
  const renderTransitions = (render) => React22.createElement(React22.Fragment, null, transitions.map((t, i) => {
    ...
    return elem && elem.type ? React22.createElement(elem.type, { ...props2, key, ref: elemRef }) : elem;
  }));
